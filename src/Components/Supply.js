...
function Supply(props){
    ...
    return(
        <div class = "section">
            ...
            <p className = "packet-description">All matching profiles updated within the last 3 years from over 130 online professional hubs and social networks.</p>
            ...
            <div style = {backgroundImageCSS}>
                ...
                <div className = "row mt-5">
                    ...
                    <div className = "col-2">
                       <p className = "supply-numbers">{Number(supply.profiles).toLocaleString()}</p>
                       <p className = "supply-description">Profiles</p>
                    </div>
                    <div className = "col-3 ">
                       <p className = "supply-numbers">X {Number(supply.benchmarkIndex).toLocaleString()} </p>
                       <p className = "supply-description">National Average</p>
                    </div>
                    <div className = "col-5 ">
                        <p className = "supply-numbers">{Number(supply.companies).toLocaleString()}</p>
